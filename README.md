...
High Risk Cases (50)
Severe incidents. ~25% of total, highlighting significant safety concerns.
Avg Risk Score (9.76)
Indicates relatively high severity across incidents.
Avg Days to Close (7.58)
...
Peak Forecast (1.12)
Highest expected incident level during peak periods.
Avg Forecast (1.02)
Baseline incident level, indicating stable but persistent risk.
Growth % (38.32%)
...
Organizations should focus on prevention, reporting efficiency, and targeted safety interventions
